...
class Review(BaseModel):
    ...
    sentiment:Literal['pos','neg']= Field(description='return sentiment of review either positive or negative')
    ...
    name:Optional[list[str]]=Field(description='Write name of the reviewer')
